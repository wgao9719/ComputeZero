...
#CREATE TABLE outputs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, response JSON NOT NULL);
...
def apicall():
    ...
    openai.api_key = "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"
    api_key = "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"
...
def extract():
    ...
    output = db.execute("SELECT response FROM outputs WHERE user_id = %s ORDER BY id DESC LIMIT 1", session["user_id"])[0]["response"]
